          ...
          <div className="footer-wrapper">
            ...
            <div className="footer-contacts">
              ...
              <div className="sm-item">
                <a href={options.facebookLink?.url} target="_blank" rel='nofollow noopener noreferrer' dangerouslySetInnerHTML={{ __html: options.facebookIcon }}></a>
                <a href={options.twitterLink?.url} target="_blank" rel='nofollow noopener noreferrer' dangerouslySetInnerHTML={{ __html: options.twitterIcon }}></a>
                <a href={options.instagramLink?.url} target="_blank" rel='nofollow noopener noreferrer' dangerouslySetInnerHTML={{ __html: options.instagramIcon }}></a>
                <a href={options.tiktokLink?.url} target="_blank" rel='nofollow noopener noreferrer' dangerouslySetInnerHTML={{ __html: options.tiktokIcon }}></a>
              </div>
              {options.email.url &&
                <>
                  <h3>{options.emailTitle}</h3>
                  <a href={options.email.url} rel='nofollow noopener noreferrer'>{options.email.title}</a>
                </>
              }

              <h3>{options.phoneTitle}</h3>
              <a href={options.phone.url} rel='nofollow noopener noreferrer'>{options.phone.title}</a>
            </div>
          </div>
